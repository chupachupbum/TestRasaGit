...
- [ros](stockcode) tham chiếu
- gia tham chiếu của [mwg](stockcode)
...
## intent:upd.stock_ceilingPrice
- giá trần của [vic](stockcode)
- [fpt](stockcode) giá trần
- giá trần của [fpt](stockcode)
- giá trần của [vnm](stockcode)
- giá trần của [hbc](stockcode)
- giá trần của [bid](stockcode)
- giá trần [vic](stockcode)
- giá trần của [gex](stockcode)

## intent:upd.stock_floorPrice
- giá sàn của [vnm](stockcode)
- [aaa](stockcode) giá sàn
- giá sàn của [ctg](stockcode)
- giá sàn [vnm](stockcode)

## intent:upd.stock_totalVolumeTraded
- tổng khối lượng giao dịch của [sab](stockcode)
- [flc](stockcode) tổng khối lượng giao dịch
- tổng khối lượng giao dịch của [bid](stockcode)

## intent:upd.stock_totalValueTraded
- tổng giá trị giao dịch của [ctg](stockcode)
- [eib](stockcode) tổng giá trị giao dịch
- tổng giá trị giao dịch của [aaa](stockcode)

## intent:upd.stock_highPrice
- giá cao nhất hôm nay của [gas](stockcode)
- giá cao nhất trong ngày của [hdb](stockcode)
- giá cao nhất bán được của [hpg](stockcode)
- giá cao nhất hôm nay của [gex](stockcode)
- giá cao nhất trong ngày của [flc](stockcode)
- giá cao nhất của [ros](stockcode)

## intent:upd.stock_lowPrice
- giá thấp nhất trong ngày của [kdh](stockcode)
- giá thấp nhất hôm nay của [mbb](stockcode)
- giá thấp nhất bán được của [msn](stockcode)
- giá thấp nhất trong ngày của [nvl](stockcode)
- giá thấp nhất của [flc](stockcode)
- giá thấp nhất trong ngày của [vre](stockcode)

## intent:upd.stock_averagePrice
- giá trung bình trong ngày của [mwg](stockcode)
- giá trung bình hôm nay của [nvl](stockcode)
- giá trung bình bán được của [plx](stockcode)
- giá trung bình của [vre](stockcode)
- giá trung bình trong ngày [vnm](stockcode)
- giá trung bình trong ngày [nvm](stockcode)
- giá trung bình trong ngày [vic](stockcode)
- giá trung bình của [nvl](stockcode)

## intent:upd.stock_foreignBuy
- nước ngoài mua [pnj](stockcode)
...
- nước ngoài bán [ree](stockcode)
- khối ngoại bán bao nhiêu [sbt](stockcode)
- lượng khối ngoại bán của [tcb](stockcode)
- khối lượng nước ngoài bán [bid](stockcode)
- khối lượng nước ngoài bán [ctg](stockcode)

## intent:upd.stock_exchangeCode
- sàn giao dịch của [ssi](stockcode)
- sàn chứng khoán của [stb](stockcode)
- [tcb](stockcode) ở sàn nào
- [tch](stockcode) nằm ở sàn chứng khoán nào
- sàn giao dịch của [att](stockcode)
...
- khối lượng chào mua [vpb](stockcode)
- tổng lượng chờ mua của [ros](stockcode)
- tổng lượng chờ mua của [ctg](stockcode)
- tổng khối lượng chờ mua của [ctg](stockcode)
- tổng khối lượng chờ mua của [nvm](stockcode)
- tổng khối lượng chờ mua của [vnm](stockcode)
- tổng khối lượng chờ mua [vnm](stockcode)
- khối lượng chờ mua [vnm](stockcode)

## intent:upd.stock_totalAskVolume
- khối lượng chờ bán của [vre](stockcode)
- khối lượng chào bán [abs](stockcode)
- tổng lượng bán [nvl](stockcode)
- tổng lượng chờ bán của [vre](stockcode)
- tổng lượng chờ bán của [cav](stockcode)

## intent:upd.stock_openPrice
- giá mở cửa của [acl](stockcode)
- [agg](stockcode) mở cửa bao nhiêu
- giá đầu tiên của [amd](stockcode)
- giá mở cửa của [bid](stockcode)
- giá mở cửa [vnm](stockcode)
- giá mở cửa của [eib](stockcode)

## intent:upd.stock_ptMatchedPrice
- giá thỏa thuận hiện tại của [agr](stockcode)
- giá thỏa thuận của [anv](stockcode)
...
- [asm](stockcode) đang thỏa thuận với khối lượng bao nhiêu
- khối lượng thỏa thuận của [bpc](stockcode)

## intent:upd.stock_ptVolume
- tổng khối lượng giao dịch thỏa thuận của [bcg](stockcode)
- [bfc](stockcode) giao dịch thỏa thuận bao nhiêu cổ
- tổng lượng giao dịch thỏa thuận [bxh](stockcode)

## intent:upd.stock_ptValue
- tổng  giá trị giao dịch thỏa thuận của [bmi](stockcode)
- [bvh](stockcode) tổng giá trị thỏa thuận
- tổng giá trị thỏa thuận [cap](stockcode)

## intent:upd.stock_currentRoom
- nước ngoài có thể mua bao nhiêu [ccl](stockcode)
- khối ngoại có thể mua bao nhiêu [ckg](stockcode)
- lượng cổ phiếu khối ngoại có thể mua của [dhp](stockcode)

## intent:upd.stock_vn30
- Cho tôi xem danh sách vn30
- Danh sách vn30
- vn30 có những cổ phiếu nào
- danh sách vn30
- dánh sách vn30
...
- cho ta xem danh sách theo dõi
- danh sách cổ thiếu theo dõi của tôi
- danh mục theo dõi của tao
- danh sách cổ phiếu theo dõi của tôi
- danh sách cổ phiếu theo dõi
- danh sách theo dõi

## intent:upd.stock_top_gainers
- các mã tăng giá nhiều nhất hôm nay
- các cổ phiếu tăng mạnh hôm nay
- các mã tăng giá đột biến

## intent:upd.stock_top_losers
- các mã giảm giá nhiều nhất hôm nay
- các cổ phiếu giảm mạnh hôm nay
- các mã giảm giá đột biến

## intent:upd.stock_top_change
- các mã biến động giá đột biến
- các mã tăng giảm đột biến

## intent:upd.stock_top_trading
- các mã thanh khoản lớn
- các mã giao dịch nhiều nhất
- các cổ phiếu được mua bán nhiều nhất

## intent:upd.stock_top_foreig
- các mã khối ngoại mua bán nhiều nhất
- các cổ phiếu được khối ngoại mua bán nhiều nhất
